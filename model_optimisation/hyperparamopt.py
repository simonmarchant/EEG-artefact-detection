...
def hyperparamopt():
    ...
    p_grid = {"min_samples_split": [2, 5, 10, 20, 40, 60], # helpful: https://scikit-learn.org/stable/modules/ensemble.html#parameters
             "max_depth": [3, 10, 20, 50, 70, 100],
    ...
    if this_is_a_test:
        p_grid = {"min_samples_split": [2, 5, 10, 20]}
    ...
    clf = GridSearchCV(estimator=rf, param_grid=p_grid, cv=outer_cv, scoring="f1_weighted", n_jobs=-1)
